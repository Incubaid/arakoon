...
/*-
 * below is an experimental version for core i7
 */

#ifdef __SSE4_2__

static uint32_t _crc32c_sse4_2_byte(uint32_t crc,
...
static uint32_t crc32c_sse4_2(uint32_t crc,
    ...
    if (rem)
	crc = _crc32c_sse4_2_byte(crc, (unsigned char *)ptmp,
				  rem);
...
uint32_t sse4_2_crc32c(const unsigned char* buffer,
    ...
    crc = crc32c_sse4_2(crc, buffer, length);
