...
//$testSuite->AddTest('UndefinedClusterIdTestCase');
$testSuite->AddTest('UnknownNodeTestCase');
$testSuite->AddTest('EmptyClusterTestCase');
$testSuite->AddTest('InvalidClientPortTestCase');

/**
 * run test
 */
$testRunner = new XmlHudsonTestRunner('arakoon-client-invalid_client_configuration-unit-tests');
$testRunner->Run($testSuite, 'invalid_client_configuration_test_report');
